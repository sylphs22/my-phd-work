library(MASS)
library(data.table)
data=fread("E:/New Volume/studies/FPM/papers/web recommeder system/datasets/Webscope_R1/Webscope_R1/ydata-ymusic-user-artist-ratings-v1_0.txt/ydata-ymusic-user-artist-ratings-v1_0.txt")
data[1:3,]
max (data$V1)
max (data$V2)
library(cvTools)
library("robustbase")
set.seed(100)
folds <- cvFolds(nrow(data), K = 5, R=1, type = "random")
